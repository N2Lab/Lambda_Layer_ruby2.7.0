...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/opt/ruby")
  ...
  CONFIG["configure_args"] = " '--prefix=/opt/ruby' '--enable-shared' 'LDFLAGS=-L/opt/ruby/lib ' 'CPPFLAGS=-I/opt/ruby/include '"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/opt/ruby"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-L/opt/ruby/lib "
  CONFIG["ALLOCA"] = ""
  CONFIG["MATHN"] = "yes"
  CONFIG["dsymutil"] = ""
  CONFIG["codesign"] = ""
  ...
  CONFIG["CXX"] = "g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/opt/ruby/include  $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/opt/ruby/lib  -fstack-protector-strong -rdynamic -Wl,-export-dynamic"
